module DatetimeFormattingHelper
  ...
  def cal_date_mailer(date)
    date.nil? ? "Get in touch now" : date.to_date.to_s(:cal_date)
  end
  ...
  # def format_for_timepicker(time)
  #   if browser.device.mobile?
  #     time.nil? ? "" : time.to_date.to_s(:time_format)
  #   else
  #     time.nil? ? "" : time.to_date.to_s(:time_format)
  #   end
  # end

  # def type_for_datepicker
  #   browser.device.mobile? ? "date" : "text"
  # end

  # def type_for_timepicker
  #   browser.device.mobile? ? "time" : "text"
  # end
